...
def load_desi_embeddings_optional():
    ...
    try:
        ...
        if embedding_field:
            ...
            print(" No embedding field found in DESI dataset")
            return None
...
def main_robust_analysis():
    ...
    try:
        ...
        if valid_scores:
            ...
            print(f"    No valid alignment scores computed")
...
if __name__ == "__main__":
    ...
    if results and results.get('analysis_successful', False):
        ...
        if scores:
            ...
            print("   No scores were successfully computed")
        ...
        if 'sdss_interpolated' in embeddings:
            ...
            if os.path.exists("sdss_interpolated_desi_grid_robust_embeddings.npy"):
                ...
                print(f"   Embedding save may have failed")
